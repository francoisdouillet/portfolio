...
const About = () => {
    return (
        <div className="home">
            ...
            <br/><br/> Je recherche une alternance de 12 mois, afin de poursuivre le développement de mes compétences. Je suis disponible immédiatement sur Laval, Angers et je suis éligible à la prime de 6000 euros. </p>
